...
<html lang="pt-br">
    ...
    <body>
        <div class = "div02">
            ...
            <hr>
            <h3>Suporte</h3>
            <h4>Precisando de uma ajuda?</h4>
            <p>Em caso de problemas com a plataforma ou precisar tirar alguma duvída a respeito de suas funcionalidades, aqui estão alguns meios para você realizar contato com o responsável.</p>
